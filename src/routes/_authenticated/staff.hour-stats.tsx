      ...
      <Card className="space-y-3 p-4">
        <div className="grid gap-3 sm:grid-cols-[12rem_1fr_auto]">
          <div className="space-y-1">
            <Label htmlFor="hour-stats-month" className="text-xs">
              Tháng thống kê
            </Label>
            <Input
              id="hour-stats-month"
          ...
          <div className="space-y-1">
            <Label htmlFor="hour-stats-search" className="text-xs">
              Tìm NLĐ
            </Label>
            <div className="relative">
              <Search className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
              <Input
                id="hour-stats-search"
                value={search}
          ...
          <Button type="button" variant="outline" onClick={handleExport} className="self-end gap-2">
