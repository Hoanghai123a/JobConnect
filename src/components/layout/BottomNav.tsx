...
import { Home, Info, ChevronLeft } from "lucide-react";
          ...
          return (
            <li key={it.to}>
              <Link
                to={it.to}
                className={cn(
                  "mx-auto flex w-full max-w-[12rem] flex-col items-center justify-center gap-0.5 rounded-2xl py-2 text-[11px] font-medium transition-colors",
                  "min-h-[56px]",
                  active
