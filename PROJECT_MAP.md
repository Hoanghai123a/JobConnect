...
- Other: PWA (service worker, web-push notifications), Recharts, xlsx, Zod
...
| `/api/push/public-key` | `routes/api/push/public-key.ts` | VAPID public key |
| `/api/push/subscription` | `routes/api/push/subscription.ts` | Push subscription save |
| `/api/push/approval` | `routes/api/push/approval.ts` | Push on approval events |
...
| `components/layout/PushPermissionPrompt.tsx` | Push notification permission UI |
...
| Push notifications | `src/lib/push-*.ts`, `src/routes/api/push/` |
